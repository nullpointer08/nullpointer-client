...
class Client(object):
    ...
    def schedule_playlist(self, playlist):
        ...
        def replace_playlist(scheduled_pl):
            del scheduled_pl[:]
            self.LOG.error("EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE")
            self.LOG.error(scheduled_pl)
            self.LOG.error(playlist)
            for media in playlist:
                self.LOG.error(scheduled_pl)
                self.LOG.error("EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE")
                self.LOG.error(media)
